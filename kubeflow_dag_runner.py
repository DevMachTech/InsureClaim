...
PREPROCESSING_FN = 'cover_advert-transform.preprocessing_fn'
...
PIPELINE_ROOT = os.path.join(OUTPUT_DIR, 'claim_pred_output',
                             PIPELINE_NAME)
...
DATA_PATH = '/content/drive/MyDrive/InsureClaim/InsureClaim/training/fselect/dataset.csv'
